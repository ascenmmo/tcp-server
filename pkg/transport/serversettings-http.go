...
func (http *httpServerSettings) SetRoutes(route *fiber.App) {
	route.Post("/api/v1/rest/serverSettings", http.serveBatch)
	route.Post("/api/v1/rest/serverSettings/getConnectionsNum", http.serveGetConnectionsNum)
	...
	route.Post("/api/v1/rest/serverSettings/setNotifyServer", http.serveSetNotifyServer)
	route.Post("/api/v1/rest/serverSettings/getGameResults", http.serveGetGameResults)
}
